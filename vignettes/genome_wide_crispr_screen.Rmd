...
```{r}
data('lib_anno_gw', package = 'ICS2021')
data('raw_counts_gw', package = 'ICS2021')
```
...
data('ce', package = 'ICS2021') # core essentials
data('ne', package = 'ICS2021') # nonessentials
...
```
```{r, echo = F, eval = T}
data('maude_guide_stats', package = 'ICS2021')
```
...
```
```{r, echo = F, eval = T}
data('maude_guide_stats_subset', package = 'ICS2021')
```
...
```{r}
data('val_data', package = 'ICS2021') # vulcan validation
data('corr_vals', package = 'ICS2021') # microscopy pbp correlation
data('ratios', package = 'ICS2021') # microscopy ratios
```
